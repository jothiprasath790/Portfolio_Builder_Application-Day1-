import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box,FormControl, FormLabel, HStack, Input, VStack, Text } from '@chakra-ui/react'
                        ...
                        <AccordionItem key={index}>
                            ...
                            <AccordionPanel pb={4}>
                                <VStack spacing={4}>
                                    ...
                                    <Input onChange={(e) => handleChange(e, index)} name='college' type='text' variant='filled' placeholder='College' />
                                </VStack>
